const createUserIDOrderFoodList = async (querySQL, userID) => {
    const sql = `CREATE TABLE IF NOT EXISTS order_food_list_${userID} (
...
module.exports = createUserIDOrderFoodList